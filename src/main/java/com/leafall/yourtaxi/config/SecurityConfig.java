...
public class SecurityConfig {
    ...
    public static final String[] PUBLIC_LIST_URLS = {"/v1/users/forgot/password","/v1/users/forgot/password/verify", "/v1/users/signin", "/connect", "/v1/users/signup","/v1/users/verify","/v1/users/logout", "/v1/users/tokens/refresh", "/v3/api-docs/**","/swagger-ui/**","/swagger-ui"};
